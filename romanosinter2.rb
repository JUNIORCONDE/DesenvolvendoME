# criando comando de conversão Numero romanos para Numeros, Inteiros, aonde não iremos usar Class e Def
# ajuda do meu especialista chatGPT para entender cada linha de comando criado.
